...
5. **70–90s — Analyze:** bind the cleaned source to the conversation and ask one aggregation question. Show the generated SQL, tool result, explanation, and chart.
